...
void calculate_EST_EFT(int task,int processor,struct TaskProcessor *EST_EFT)
{
   ...
   machineFreeTime=new double*[100];
    for(i=0; i<100; i++){
     //   machineFreeTime[i]=(double*)calloc(2,sizeof(double));
    machineFreeTime[i]=new double[2];
	}
	int noslots=0;
